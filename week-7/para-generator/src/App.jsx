  ...
  return (
    <>
      <div class="flex flex-col items-center pt-28">
        ...
        <div class="mt-7">
          <input onChange={(e) => setWords(e.target.value)} class="h-14 sm:w-[750px] border border-gray-300 px-4 py-2 focus:outline-0" type="search" name="" placeholder="Enter the number of words" id="" />
