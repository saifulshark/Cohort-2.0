    ...
    return (
        <>
            <div className="flex items-center justify-center">
                <div className="relative z-0 h-[400px] sm:h-[600px] w-[100%] bg-[url('https://wallpapercave.com/wp/wp9160769.jpg')] object-fill blur-sm" style={{backgroundSize: 'cover'}}></div>
                <div className="absolute z-10 flex sm:h-80 w-[80%] sm:w-[60%] flex-col items-center justify-start rounded-2xl bg-gray-400 bg-opacity-60 shadow-2xl">
                    <p className="mt-5 p-1 text-4xl text-center sm:text-5xl font-medium">Tell us about your birthday!</p>
                    <input onChange={handleName} type="text" className="mt-12 h-9 sm:w-2/4 rounded text-center caret-slate-950" name="" placeholder="Enter Your Name" />
                    <input onChange={handleBirthday} type="date" className="mt-7 h-9 sm:w-2/4 rounded text-center" name="" placeholder="Enter Your Name" />
