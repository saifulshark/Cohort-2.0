export default function BirthdayCard({name, dob}){
    return (
        <div className="m-3 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
            ...
            <a href="#">
                ...
                <p className="mb-3 font-normal text-gray-500 ">Birthday: {dob}</p>
